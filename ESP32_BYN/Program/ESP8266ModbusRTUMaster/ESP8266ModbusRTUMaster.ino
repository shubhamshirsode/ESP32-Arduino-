...
/////     Holding Register [10] A [19]   =  10 Holding Registers Reading  
  ...
  node.writeSingleRegister(10, random(1, 1000 )); 
  node.writeSingleRegister(11, random(1, 1000 )); 
  node.writeSingleRegister(12, random(1, 1000 )); 
  node.writeSingleRegister(13, random(1, 1000 )); 
  node.writeSingleRegister(14, random(1, 1000 )); 
  node.writeSingleRegister(15, random(1, 1000 )); 
  node.writeSingleRegister(16, random(1, 1000 )); 
  node.writeSingleRegister(17, random(1, 1000 )); 
  node.writeSingleRegister(18, random(1, 1000 )); 
